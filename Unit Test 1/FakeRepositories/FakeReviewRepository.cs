...
namespace Unit_Test_1.FakeRepositories
{
    public class FakeReviewRepository : IReviewRepository
    {
        ...
        public List<ReviewDTO> GetReviewsByUser(int userId) => new List<ReviewDTO>
        {
            new ReviewDTO(1, userId, 0, 1, 8, "Great song!", "Lavender Haze", ""),
            new ReviewDTO(2, userId, 1, 0, 9, "Great album!", "", "Midnights")
        };
